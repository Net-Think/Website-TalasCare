          ...
          <div class="col-xxl-5 col-xl-6 col-lg-7">
            <div class="section-title text-center mb-30">
              ...
              <p class="wow fadeInUp" data-wow-delay=".4s">
                Lorem ipsum dolor samet consetetur sadipscing elitr, serewd diam
          ...
          <div class="col-lg-4 col-md-8 col-sm-10">
            <div class="single-feature">
              ...
              <div class="content">
                <h3>Lorem ipsum</h3>
                <p>
                  Lorem ipsum dolor samet consetet sadip scing elitr serewd diam
                  nonumy eirmod tempor invidunt ut labore.
                </p>
              </div>
            </div>
        ...
        <div class="row align-items-center">
          <div class="col-lg-6 col-xl-7">
            <div class="tracking-image">
              <img src="assets/img/plan/zxc.png" width="100%" alt="" />
            </div>
          </div>
            ...
            <div class="tracking-content">
              <div class="section-title mb-50">
                <h1 class="mb-40 wow fadeInUp" data-wow-delay=".2s">
                  Ciri-ciri Umum Talas Anda Terjangkit Hama dan Penyakit
                </h1>
                <p class="wow fadeInUp" data-wow-delay=".4s">
                  Berikut adalah beberapa ciri-ciri umum talas yang terjangkit hama dan penyakit:
                </p>
              </div>
              <div class="single-plan">
                ...
                <div class="content">
                  <h3>Daun yang Menguning atau Menggugurkan</h3>
                  <p>
                    Daun talas yang menguning atau gugur secara berlebihan bisa menjadi tanda adanya masalah.
                  </p>
                </div>
              </div>
              <div class="single-plan">
                ...
                <div class="content">
                  <h3>Bintik-bintik atau Noda pada Daun</h3>
                  <p>
                    Bintik-bintik hitam, cokelat, atau putih pada daun talas adalah indikasi serangan penyakit seperti jamur atau bakteri.
                  </p>
                </div>
              </div>
              <div class="single-plan">
                ...
                <div class="content">
                  <h3>Daun yang Lecet atau Berlubang</h3>
                  <p>
                    Daun talas yang memiliki bekas gigitan, lubang, atau kerusakan fisik lainnya, hal ini mungkin disebabkan oleh serangan hama seperti ulat atau kutu.
                  </p>
                </div>
              </div>
            </div>
 ...
 <section id="faq">
    ...
    <div class="container my-5 py-5 ">
      ...
      <div class="accordion col-md-10 offset-md-1" id="accordionPanelsStayOpenExample">
          ...
          <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show">
            <div class="accordion-body">
              <p>Diam orci gravida convallis at enim risus viverra. Hac mi tristique in aliquet tincidunt nam lectus
                nec. Placerat interdum auctor facilisi massa laoreet hendrerit posuere a. Tristique ultricies consectetu
                at.</p>
            </div>
          </div>
        </div>
        ...
        <div class="accordion-item mt-3" data-aos="fade-up" data-aos-easing="ease-in-sine" data-aos-delay="500">
