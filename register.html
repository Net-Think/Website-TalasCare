                    ...
                    <div class="card shadow mt-5">
                        <div class="row">
                            <div class="col-md-5 d-none d-lg-block">
                                <img src="assets/image/talas.png" alt="..." class="img-fluid login">
                            </div>
                            <div class="col-md-7">
                                <div class="card-body">
                                    <h3 class="card-title mt-1">Daftar Akun</h3>
                                    <div class="row mt-3">
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label class="label-auth">Username</label>
                                                <input type="text" class="form-profil" placeholder="Cnth. zaky">
                                            </div>
                                            <div class="form-group">
                                                <label class="label-auth">Email</label>
                                                <input type="text" class="form-profil" placeholder="Cnth. zakyahmad@gmail.com">
                                            </div>
